...
* Corrected the Web Push client VAPID public key endpoint path
...
* Fixed the client library description shown on its package page

## [0.6.1] - 2026-06-22

### Fixed

* Restored publishing of the client library package on release
